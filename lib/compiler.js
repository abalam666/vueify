...
//if (filePath=='app/vue/mainmenu.vue') console.log(filePath)
//if (filePath=='app/vue/mainmenu.vue') console.log('coffee',script)
  return compileAsPromise('script', script, lang, filePath)
    .then(function (res) {
//if (filePath=='app/vue/mainmenu.vue') console.log('es6',typeof res === 'string' ? res : res.code)
      compileAsPromise('script', typeof res === 'string' ? res : res.code, 'babel', filePath)
      .then(function (res) {
//if (filePath=='app/vue/mainmenu.vue') console.log('es5',typeof res === 'string' ? res : res.code)
